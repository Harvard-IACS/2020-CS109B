...
class GenerateStructure:
    ...
    def create_homework(self, directory, number_of_labs, folders):
        for i in range(1, number_of_labs+1):
            ...
            if not os.path.exists(directory + "hw" + str(i)):
                os.makedirs(directory + "hw" + str(i))

                directory_homework = directory + "hw" + str(i) + '/'
...
if __name__ == "__main__":
    number_of_lectures = 26
    number_of_labs = 12
    number_of_homework = 8
    number_of_advanced_sections = 5
    number_of_sections = 0
    folders = ["data", "images", "notebook", "presentation"]
